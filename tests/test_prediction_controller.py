...
class TestPredictionResource:
    ...
    def test_get_predictions_success(self, client, mock_db_connection):
        ...
        mock_predictions = [
            (
                1, 1, 1, date(2024, 6, 1), 100.5, 90.0, 110.0, 0.5, 0.3, 0.7, 10.0, 8.0,
                12.0, 1000000.0, 900000.0, 1100000.0, 1000000.0, 950000.0, 1050000.0
            ),
            (
                2, 1, 1, date(2024, 6, 2), 101.0, 91.0, 111.0, 0.6, 0.4, 0.8, 11.0, 9.0,
                13.0, 1010000.0, 910000.0, 1110000.0, 1010000.0, 960000.0,1060000.0
            )
        ]
    ...
    def test_get_predictions_with_country_filter(self, client, mock_db_connection):
        ...
        mock_predictions = [
            (
                1, 2, 1, date(2024, 6, 1), 100.5, 90.0, 110.0, 0.5, 0.3, 0.7, 10.0, 8.0,
                12.0, 1000000.0, 900000.0, 1100000.0, 1000000.0, 950000.0, 1050000.0
            )
        ]
        mock_cursor.fetchall.return_value = mock_predictions
        ...
        with client.application.app_context():
            ...
            response = client.get(
                f'/swagger/predictions/get?disease_id=1&start_date={start_date}&end_date={end_date}&country_id=2',
                headers=headers
            )
    ...
    def test_get_predictions_missing_disease_id(self, client):
        ...
        with client.application.app_context():
            ...
            response = client.get(
                f'/swagger/predictions/get?start_date={start_date}&end_date={end_date}',
                headers=headers
            )
    ...
    def test_get_predictions_missing_end_date(self, client):
        ...
        with client.application.app_context():
            ...
            response = client.get(
                f'/swagger/predictions/get?disease_id=1&start_date={start_date}',
                headers=headers
            )
    ...
    def test_get_predictions_invalid_date_format(self, client):
        ...
        with client.application.app_context():
            ...
            response = client.get(
                '/swagger/predictions/get?disease_id=1&start_date=invalid-date&end_date=2024-06-30',
                headers=headers
            )
    ...
    def test_get_predictions_start_date_today(self, client, mock_db_connection):
        ...
        with client.application.app_context():
            ...
            response = client.get(
                f'/swagger/predictions/get?disease_id=1&start_date={today_date}&end_date={future_date}',
                headers=headers
            )
...
class TestPredictionModel:
    ...
    def test_prediction_model_field_types(self):
...
class TestPredictionDataProcessing:
    ...
    def test_date_formatting_in_response(self, client, mock_db_connection):
        ...
        mock_predictions = [
            (
                1, 1, 1, test_date, 100.5, 90.0, 110.0, 0.5, 0.3, 0.7, 10.0, 8.0, 12.0, 1000000.0,
                900000.0, 1100000.0, 1000000.0, 950000.0, 1050000.0
            )
        ]
        mock_cursor.fetchall.return_value = mock_predictions
    ...
    def test_numeric_values_in_response(self, client, mock_db_connection):
        ...
        mock_predictions = [
            (
                1, 1, 1, date(2024, 6, 1), 100.5, 90.0, 110.0, 0.5, 0.3, 0.7, 10.0, 8.0, 12.0,
                1000000.0, 900000.0, 1100000.0, 1000000.0, 950000.0, 1050000.0
            )
        ]
        mock_cursor.fetchall.return_value = mock_predictions

...
class TestCountryController:
        ...
        mock_countries = [
            {
                ...
                'population': 67000000, 'pib': '$2800000000000','latitude': 46.2276,
                'longitude': 2.2137, 'id_continent': 1,'id_region': 1
            },
            {
                'id_country': 2, 'name': 'Germany', 'iso_code': 'DE',
                'population': 83000000, 'pib': '$3800000000000', 'latitude': 51.1657,
                'longitude': 10.4515, 'id_continent': 1, 'id_region': 2
            }
        ]
    ...
    def test_get_country_by_id_success(self, client):
        ...
        mock_country = {
            'id_country': 1, 'name': 'France', 'pib': '$2800000000000',
            'iso_code': 'FR', 'population': 67000000, 'latitude': 46.2276,
            'longitude': 2.2137, 'id_continent': 1, 'id_region': 1
        }
...
class TestCountryNamespace:
    ...
    def test_countries_namespace_get(self, client):
...
class TestCountryModel:
    ...
    def test_country_model_structure(self):
    ...
    def test_country_model_field_types(self):

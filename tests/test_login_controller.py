...
from controller.login_controller import check_if_admin, user_namespace
...
class TestLoginResource:
    ...
    def test_login_invalid_json(self, client):
        ...
        if response.json:
            assert 'Données invalides' in response.json.get('msg', '') \
                or 'Erreur serveur' in response.json.get('msg', '')
...
class TestUserModels:
    ...
    def test_login_model_structure(self):
